...
class Contact extends Component{
    ...
    validate(firstname, lastname, telnum, email){
        ...
        if (this.state.touched.lastname && lastname.length < 3)
            errors.lastname = "Lirst Name should be >= 3 characters";
        else if (this.state.touched.lastname && lastname.length > 10)
            errors.lastname = "Lirst Name should be <= 10 characters";
                ...
                <div className='col-12 col-md-9'>
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <FormGroup row>
                            ...
                            <Col md={10}>
                                <Input  type='text' id='lastnam' name='lastname' 
                        ...
                        <FormGroup row>
                            ...
                            <Col md={10}>
                                ...
                                rows={12}  cols={75} value={this.state.message} 
                                onChange={this.hundleInputChange} ></textarea>
                            </Col>
                        </FormGroup>
                        <FormGroup row>
